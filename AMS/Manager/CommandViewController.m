...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.lblCreateBy.text =StringFormat(@"Bạn gửi chỉ thị tới: %@", item.c_username);
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    DetailCommandViewController *detailCommandViewController = [[DetailCommandViewController alloc] initWithNibName:@"DetailCommandViewController" bundle:nil Data:item Type:@"Manager"];
...
-(void)getData:(NSString *)pageNum PerPage:(NSString *)perPage{
    ...
    [[ShareData instance].dataProxy getManagerCommand:pageNum PerPage:perPage completeHandler:^(id result, NSString *errorCode, NSString *message) {
