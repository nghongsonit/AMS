...
@interface HEViewController2 ()
{
    int time;
}
@end

@implementation HEViewController2
...
-(void)initChart:(NSArray *)arrData{
    ...
    NSMutableArray *arrNO2 = [[NSMutableArray alloc] init];
    for (ChartEnvironmentRecord *item in arrData) {
        ...
        [arrNO2 addObject:envi.e_no2];
    }

    
    lineChart = [[PNLineChart alloc] initWithFrame:CGRectMake(20, 150.0, SCREEN_WIDTH-20, 200.0)];
    lineChart.backgroundColor = [UIColor clearColor];
    lineChart.showCoordinateAxis = YES;
    [lineChart setXLabels:arrDate];
    
    // Line Chart No.1
    NSArray * data01Array = arrNO2;
