...
@interface HEViewController3 ()
{
    int time;
}
@end

@implementation HEViewController3
...
-(void)initChart:(NSArray *)arrData{
    ...
    NSMutableArray *arrPH = [[NSMutableArray alloc] init];
